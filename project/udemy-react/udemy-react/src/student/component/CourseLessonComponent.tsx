            ...
            <>
              ...
              <div className="bg-slate-950/40 border border-slate-800/60 p-6 rounded-2xl backdrop-blur-sm">
                ...
                <p className="text-sm text-slate-400 mt-2 leading-relaxed">
                  သင်ခန်းစာကို စတင်ကြည့်ရှုရန် ဗီဒီယိုအလယ်ရှိ{" "}
                  <strong>Play ခလုတ်ကို နှိပ်ပေးပါ။</strong> ညာဘက်ရှိ Playlist
                  စာရင်းများမှလည်း စိတ်ကြိုက်ရွေးချယ် ကလစ်နှိပ်နိုင်ပါသည်။
                </p>
              </div>
            </>
          ) : (
          ...
          {lessonsList.map((lesson: Lesson, index: number) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`mt-0.5 flex-shrink-0 w-6 h-6 rounded-lg flex items-center justify-center text-xs font-bold ${
                    isActive
                ...
                <div className="flex-1 min-w-0">
                  <p
                    className={`text-sm font-semibold tracking-wide leading-tight ${isActive ? "text-white" : "text-slate-200 group-hover:text-indigo-300"}`}
                  >
                    {lesson.lessonName}
                  </p>
                </div>
