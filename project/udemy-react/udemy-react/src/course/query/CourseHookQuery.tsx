...
export function useAllGetEnrolledCourses() {
  return useQuery<Course[]>({
    queryKey: ["enrolled-courses"],
    queryFn: getEnrolledCourseRequest,
    staleTime: 1000 * 5,
  });
}
...
export function useCreateLesson(courseId: number) {
  ...
  return useMutation({
    ...
    mutationFn: (newLesson: Lesson) => addLessonsApiRequest(courseId, newLesson),
    onSuccess: () => {
